...
$qresult=mysqli_query($con,"select * from employees where empid!= '100' AND branchid='$_POST[branchid]'");
}
else
{
$qresult=mysqli_query($con,"select * from employees where empid!= '100' ");
}
	$qresultbranch=mysqli_query($con,"select * from branch");
	?>
    <div id="templatemo_content">
   	
        <div id="templatemo_content_left">
        	<div class="header_02"><strong><a href="addemployees.php">Add Employee</a></strong></div>
			<div class="header_02"><strong><a href="editemployees.php">Edit Employee</a></strong></div>
               	<div class="header_02">
               	  <form id="form1" name="form1" method="post" action="">
               	    <label for="branchid"><strong>Select Branch </strong></label>
               	    <select name="branchid" id="branchid">
                    <?php
                   while($arrows = mysqli_fetch_array($qresultbranch))
				   {
   	      ...
   	      <table width="500" border="1">
       	      <tr>
			    <th width="75" scope="col">Employee ID</th>
			...
			<?php
			while($arrvar=mysqli_fetch_array($qresult))
			{
...
$qresulta=mysqli_query($con,"select * from branch where branchid='$arrvar[branchid]'");
$arrowsbr = mysqli_fetch_array($qresulta);

...
<?php
	...
	if(isset($_POST["addbranch"]))
	{
		...
		{
		echo $brad = "New branch record inserted successfully...";
		}
	}
	
		if(isset($_POST["updatebtn"]))
		{
		mysqli_query($con,"UPDATE branch SET branchname='$_POST[branchname]',address='$_POST[address]',city='$_POST[city]',state='$_POST[state]',country='$_POST[country]',contactno='$_POST[contactno]' where branchid='$_POST[brid]'");
		...
		{
				mysqli_query($con,"DELETE FROM branch where branchid='$_POST[brid]'");
						header("Location: addnewbranch.php");
		}
	
			$branchreca=mysqli_query($con,"select * from branch where branchid='$_GET[brid]'");	
			$arrvara=mysqli_fetch_array($branchreca);
    ...
    <div id="templatemo_content_left">
          ...
          <form id="formadb" name="formadb" method="post" action="" onsubmit="return validateFormadbr()">
            ...
            <table width="500" border="3">
              <tr>
                <th scope="col">&nbsp;</th>
                <th scope="col" align="left">&nbsp;<?php echo $brid; ?></th>
              </tr>
              <tr>
                <th scope="col"><strong>Branch Name</strong></th>
                <th scope="col" align="left">
                <input type="hidden" name="brid" id="brid" value="<?php echo $_GET["brid"]; ?>"/>
            ...
            <select name="country" id="country"  onChange="getState(this.value)">
              ...
              <tr>
                ...
                <td>
                <?php
				$arrcont = array("Dhaka","Chittagong","Khulna","Mymensingh","Sylhet","Rangpur","Rajshahi","Barisal");
				?>
               <div id="statediv">
          ...
          <table width="500" border="1">
            ...
            <?php
			$branchrec  =mysqli_query($con,"select * from branch");
			while($arrvar=mysqli_fetch_array($branchrec))
			{
				
				echo "        <tr>
              <td>&nbsp;<a href='addnewbranch.php?brid=$arrvar[branchid]'>$arrvar[branchname]</a></td>
              <td>&nbsp;$arrvar[city]</td>
              <td>&nbsp;$arrvar[state]</td>

...
{
	$resulta = mysqli_query($con,"select * from branch where branchid='$_POST[branchid]' ");
	$resultb = mysqli_query($con,"select * from employees where empid='$_POST[empid]'");
	$resemp = mysqli_fetch_array($resultb);
...
$dttim2 =  $_POST["year"]."-".$_POST["month"]."-". $num;
		...
		$resultbt = mysqli_query($con,$sqlatt);
		$resempt = mysqli_num_rows($resultbt);
}
        ...
        <div id="templatemo_content_left">
            ...
            <table width="480" height="451" border="3">
			 ...
			 $lic = $resemp["basicsalary"]*10/100; 
		      ...
		      $noattday =$totworkingdays-$resemp["basicsalary"];

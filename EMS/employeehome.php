...
$logindt = date("Y-m-d");
$qresult=mysqli_query($con,"SELECT * FROM attendance WHERE logintime >  '$logindt 00:00:00' AND logintime <  '$logindt 23:59:59' AND empid ='$_SESSION[emid]'");
        ...
        <div id="templatemo_content_left">
			...
			//	}
              ...
              <tr>
                ...
                <td>&nbsp;<?php 
				$txtb = mysqli_query($con,"select * from branch where branchid='$_SESSION[brid]'");
				$rowsrec = mysqli_fetch_array($txtb);
			  ...
			  {
			  ?>
                <input type="submit" name="logout" id="logout" value="Generate Time" />
                 <?php
			  }
			  ?>	 
                </td>

...
if(isset($_POST["update"]))
{
	...
	mysqli_query($con,"UPDATE employees SET fname='$_POST[fname]',lname='$_POST[lname]',loginid='$_POST[loginid]',password='$_POST[newpassword]' where empid='$empidss' AND password='$_POST[oldpassword]'");
	if(mysqli_affected_rows($con) == 1)
	{
	echo $att = "Admin profile and Password updated successfully...";
	}
	
	}
	else
	{
	mysqli_query($con,"UPDATE employees SET fname='$_POST[fname]',lname='$_POST[lname]',loginid='$_POST[loginid]' where empid='$empidss'");
		echo $att = "Admin profile updated successfully...";
	}
}
	$resultq = mysqli_query($con,"select * from employees where empid='100'");
	while($rowsa = mysqli_fetch_array($resultq))
	{
	$fname = $rowsa["fname"];
	$lname = $rowsa["lname"];
